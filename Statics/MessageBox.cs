        ...
        public string Show(object sender)
        {
            ...
            switch (this.MessageIcons)
            {
                ...
                case MessageBoxIcons.Warnning:
                    iconUrl = "<img src ='../Images/MessageBox/1.jpg' />";
                    break;
                case MessageBoxIcons.Error:
                    iconUrl = "<img src ='../ImagesMessageBox//2.jpg' />";
                    break;
                case MessageBoxIcons.Question:
                    iconUrl = "<img src ='../Images/MessageBox/3.jpg' />";
                    break;
                case MessageBoxIcons.System:
                    iconUrl = "<img src ='../Images/MessageBox/4.jpg' />";
                    break;
            }
